...
Anweisungen zum Verwalten von Buckets mithilfe der Astra API finden Sie im link:https://docs.netapp.com/us-en/astra-automation-2108/["Astra Automation und API-Informationen"^].
...
Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/astra-automation-2108/index.html["Verwenden Sie die Astra Control API"^].
